...
if "light" == &bg
  ...
  if !s:mimic_dejavu_dark
    hi Normal	guifg=#000000	guibg=#f3f3f3	gui=NONE	ctermfg=black	ctermbg=white	cterm=NONE
    hi Cursor	guifg=bg	guibg=#666666	gui=NONE	ctermfg=fg	ctermbg=green	cterm=NONE
  ...
  if version < 700
    if !s:mimic_dejavu_dark
      ...
      hi LineNr	guifg=#767676	guibg=bg	gui=NONE	ctermfg=gray	ctermbg=bg	cterm=NONE
    else
    ...
    if !s:mimic_dejavu_dark
      hi Visual		guibg=#d7d7d7	gui=NONE	ctermfg=bg	ctermbg=blue	cterm=NONE
      hi VisualNOS		guibg=#d7cfdf	gui=NONE	ctermfg=bg	ctermbg=red	cterm=NONE
      hi LineNr	guifg=#767676		gui=NONE	ctermfg=gray	ctermbg=bg	cterm=NONE
    else
  ...
  " folding {{{4
  if !s:mimic_dejavu_dark
    hi NonText	guifg=#767676	guibg=bg	gui=NONE	ctermfg=gray	ctermbg=bg	cterm=NONE
  ...
  if !s:mimic_dejavu_dark
    ...
    hi Comment	guifg=#757575	guibg=bg	gui=NONE	ctermfg=darkcyan	ctermbg=bg	cterm=NONE
